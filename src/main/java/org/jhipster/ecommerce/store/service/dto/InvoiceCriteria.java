...
/**
 * Criteria class for the {@link org.jhipster.ecommerce.store.domain.Invoice} entity. This class is used
 * in {@link org.jhipster.ecommerce.store.web.rest.InvoiceResource} to receive all the possible filtering options from
